...
type VspApiService service
/*
VspApiService vsp operation
Operace &#x27;GetGetstudent&#x27; z kategorie &#x27;vsp&#x27;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *VspApiGetGetstudentOpts - Optional Parameters:
     * @param "StagUser" (optional.String) - 
     * @param "OsCislo" (optional.String) - 
@return VspStudentType
*/

type VspApiGetGetstudentOpts struct {
    StagUser optional.String
    OsCislo optional.String
}

func (a *VspApiService) GetGetstudent(ctx context.Context, localVarOptionals *VspApiGetGetstudentOpts) (VspStudentType, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VspStudentType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vsp/getStudent"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *VspApiGetGetstudijniplanOpts - Optional Parameters:
     * @param "StplIdno" (optional.Int64) - 
@return VspStudijniPlanType
*/

type VspApiGetGetstudijniplanOpts struct {
    StplIdno optional.Int64
}

func (a *VspApiService) GetGetstudijniplan(ctx context.Context, localVarOptionals *VspApiGetGetstudijniplanOpts) (VspStudijniPlanType, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VspStudijniPlanType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vsp/getStudijniPlan"
